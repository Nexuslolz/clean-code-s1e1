...
var addButton = document.querySelector(".page-section__btn");//first button
...
var createNewTaskElement = function (taskString) {
    ...
    listItem.classList.add('site-list__item')
    label.innerText = taskString;
    label.classList.add('site-list__label');

    //Each elements, needs appending
    checkBox.type = "checkbox";
    checkBox.classList.add('site-list__input');
    ...
    editButton.classList.add('site-list__btn');
    editButton.classList.add('btn-edit');

    deleteButton.classList.add('site-list__btn');
